...
export function getSharedTagIds(bookmarks: BookmarkWithRelations[]) {
...
export function getSharedCollectionIds(bookmarks: BookmarkWithRelations[]) {
  if (bookmarks.length === 0) return [];
...
export function sameBookmarkIds(a: string[], b: string[]) {
