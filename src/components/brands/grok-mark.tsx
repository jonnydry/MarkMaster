/**
 * Grok symbol (Feb 2025 wordmark variant); paths from Wikimedia Commons work
 * derived from grok.com — trademark xAI; use only per https://x.ai/legal/brand-guidelines
 */
