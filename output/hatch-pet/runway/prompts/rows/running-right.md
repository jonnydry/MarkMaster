Create a single horizontal sprite strip for the Codex app digital pet `runway` in the state `running-right`.
...
Output exactly 8 separate animation frames arranged left-to-right in one single row. Each frame must show the same pet: Adult chibi runway fashion mascot, inspired by glamorous runway lingerie styling but not by any real person or brand; warm brown hair; tiny confident face; white and pink non-transparent bodysuit-like fashion costume; pink platform heels; no logos; no explicit anatomy; friendly digital pet personality..
